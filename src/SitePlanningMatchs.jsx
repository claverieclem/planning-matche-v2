  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-amber-50">
      <div className="mx-auto max-w-7xl space-y-8 p-6 md:p-10">
        <div className="grid items-start gap-6 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="space-y-6">
            ...
            <div className="flex flex-col gap-3 md:flex-row">
              <div className="w-full rounded-2xl border border-red-200 bg-white p-4 text-center shadow-sm">
              ...
              <div className="w-full rounded-2xl border border-blue-200 bg-white p-4 text-center shadow-sm">
              ...
              <div className="w-full rounded-2xl border border-amber-200 bg-white p-4 text-center shadow-sm">
          ...
          <div className="space-y-6">
            <Card className="rounded-2xl border border-red-100 bg-white shadow-md backdrop-blur">
              ...
              <CardContent className="space-y-4">
                <label className="block">
                  <div className="flex min-h-36 cursor-pointer flex-col items-center justify-center gap-3 rounded-2xl border border-dashed border-red-300 bg-white p-6 text-center transition-colors hover:bg-red-50">
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <Button onClick={() => window.print()} disabled={!matches.length && !introImage} className="rounded-xl bg-red-700 text-white hover:bg-red-800">
            ...
            <Card className="rounded-2xl border border-red-100 bg-white shadow-md backdrop-blur">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex flex-wrap gap-3">
                  <Button variant={showHome ? 'default' : 'outline'} className={showHome ? 'rounded-xl bg-red-700 text-white hover:bg-red-800' : 'rounded-xl border-red-300 text-red-600 hover:bg-red-50'} onClick={() => setShowHome((value) => !value)}>
                    {showHome ? 'Domicile affiché' : 'Afficher domicile'}
                  </Button>

                  <Button variant={showAway ? 'default' : 'outline'} className={showAway ? 'rounded-xl bg-blue-700 text-white hover:bg-blue-800' : 'rounded-xl border-blue-300 text-blue-600 hover:bg-blue-50'} onClick={() => setShowAway((value) => !value)}>
                ...
                <div className="flex items-center gap-3 text-sm text-muted-foreground">
                  <Button type="button" variant="outline" className="rounded-xl border-red-200 bg-white text-red-700 hover:bg-red-50" onClick={goPrevSlide} disabled={safeSlideIndex === 0 || !slides.length}>
                    <ChevronLeft className="mr-2 h-4 w-4" /> Précédent
                  </Button>
                  <div>
                    Slide {slides.length ? safeSlideIndex + 1 : 0} / {slides.length}
                  </div>
                  <Button type="button" variant="outline" className="rounded-xl border-red-200 bg-white text-red-700 hover:bg-red-50" onClick={goNextSlide} disabled={!slides.length || safeSlideIndex === slides.length - 1}>
        ...
        <div className="space-y-6">
          {!matches.length ? (
            <Card className="rounded-2xl border border-red-100 bg-white shadow-md">
              <CardContent className="p-6 md:p-7 text-center text-muted-foreground">
                Importe un fichier pour voir le planning.
              </CardContent>
            </Card>
          ) : (
            <>
              ...
              <div className="space-y-4">
                {activeSlide?.type === 'intro' ? (
                  <div className="overflow-hidden rounded-[28px] border bg-white shadow-2xl">
                    <img key={introImage} src={introImage} alt="Page intro" className="h-[820px] w-full object-cover" />
                  </div>
                ) : null}

                {activeSlide?.type === 'matches' ? (
                  <div className="min-h-[820px] overflow-hidden rounded-[28px] border shadow-2xl" style={{ background: background ? `url(${background}) center/cover` : '#7f1d1d' }}>
                    ...
                    <div className="min-h-[820px] bg-black/15 p-6 md:p-8">
                      <div className="mx-auto max-w-4xl space-y-6">
                        ...
                        <div className="rounded-3xl border border-dashed border-white/40 bg-black/10 p-10 text-center text-white/90">
                          ...
                          <div className="mt-3 text-sm md:text-base">Ajoute une page intro et importe un fichier Excel pour voir les slides du post une par une.</div>
                        </div>
                      </div>
                    </div>
                  </div>
